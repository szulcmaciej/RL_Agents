...
from agent import AlphaTicTacToeAgent
...
current_player = AlphaTicTacToeAgent('current_player', env.state_size, config.MCTS_SIMS, config.CPUCT, current_NN)
best_player = AlphaTicTacToeAgent('best_player', env.state_size, config.MCTS_SIMS, config.CPUCT, best_NN)
